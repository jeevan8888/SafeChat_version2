...
import initialScreen from './components/home';
...
import Header from "@cometchat/chat-uikit-react-native/src/shared/views/CometChatList/Header";
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator headerMode="none" initialRouteName="SignIn">
        ...
        <Stack.Screen name="aaa" component={Home} />
        ...
        <Stack.Screen name="ChatHeader" component={Header} />
